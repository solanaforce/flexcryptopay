...
class Monero(Crypto):
    ...
    def __init__(self) -> None:
        ...
        self.MONERO_WALLET_NAME = os.environ.get("MONERO_WALLET_NAME", "flexcryptopay")
        self.MONERO_WALLET_PASS = os.environ.get("MONERO_WALLET_PASS", "flexcryptopay")
        ...
        self.MONERO_WALLET_RPC_USER = os.environ.get(
            "MONERO_WALLET_RPC_USER", "flexcryptopay"
        )
        self.MONERO_WALLET_RPC_PASS = os.environ.get(
            "MONERO_WALLET_RPC_PASS", "flexcryptopay"
        )
    ...
    def dump_wallet(self) -> Tuple[str, str]:
        filename = "flexcryptopay-monero-mnemonic-key.txt"

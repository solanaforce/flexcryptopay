...
from flexcryptopay.wallet_encryption import WalletEncryptionRuntimeStatus

from .utils import format_decimal
from .events import flexcryptopay_initialized
...
def create_app(test_config=None):
    ...
    app.config.from_mapping(
        ...
        DATABASE=os.path.join(app.instance_path, "flexcryptopay.sqlite"),
        SQLALCHEMY_DATABASE_URI="sqlite:///"
        + os.path.join(app.instance_path, "flexcryptopay.sqlite"),
    ...
    class FlexcryptopayJSONDecoder(JSONDecoder):
        def __init__(self, *args, **kwargs):
            super().__init__(*args, parse_float=Decimal, **kwargs)

    class FlexcryptopayJSONEncoder(JSONEncoder):
        def default(self, obj):
            if isinstance(obj, Decimal):
                return str(obj)
            return super().default(self, obj)

    app.json_decoder = FlexcryptopayJSONDecoder
    app.json_encoder = FlexcryptopayJSONEncoder
    ...
    with app.app_context():
        ...
        import flexcryptopay.modules.rates
